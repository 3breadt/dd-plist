...
public class UidTest {
  ...
  public void getBytes_returnsMinimumPossibleLength() {
    ...
    assertEquals(
        8, new UID(null, new byte[] {0x01, 0x00, 0x00, 0x00, 0x00, 0x00}).getBytes().length);
    assertEquals(
        8, new UID(null, new byte[] {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}).getBytes().length);
    assertEquals(
        8,
        new UID(null, new byte[] {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})
            .getBytes()
            .length);
    assertEquals(
        16,
        new UID(null, new byte[] {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})
            .getBytes()
            .length);
    assertEquals(
        16,
    ...
    assertEquals(
        16,
        new UID(null, new byte[] {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})
            .getBytes()
            .length);
    assertEquals(
        16,
        new UID(null, new byte[] {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})
            .getBytes()
            .length);
    assertEquals(
        16,
        new UID(
                null,
                new byte[] {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00})
            .getBytes()
            .length);
    assertEquals(
        16,
