...
public class DeSerializationTest {
  ...
  public void testToJavaObjectNSDictionaryToObjectWithMapOfLists() {
    assertEquals(genTest1Object(), genTest1Dict().toJavaObject(TestClass1.class));
  }

  @Test
  public void testToJavaObjectNSDictionaryToObjectWithArrays() {
    assertEquals(genTest3Object(), genTest3DictOfArrays().toJavaObject(TestClass3.class));

    assertEquals(genTest3Object(), genTest3DictOfSets().toJavaObject(TestClass3.class));
  }
  ...
  public void testFromJavaObjectObjectWithPrimitivesToNSDictionary() {
    assertEquals(NSObject.fromJavaObject(genTest2Object()), genTest2Dict());
  }

  @Test
  public void testFromJavaObjectObjectWithArraysToNSDictionary() {
    assertEquals(NSObject.fromJavaObject(genTest3Object()), genTest3DictOfArrays());
  }

  @Test
  public void testFromJavaObjectObjectWithMapOfListsToNSDictionary() {
    assertEquals(NSObject.fromJavaObject(genTest1Object()), genTest1Dict());
  }
  ...
  public void testToJavaObjectNSDataToByteArray() throws Exception {
    ...
    assertArrayEquals(
        new byte[] {
          (byte) 0xC0, (byte) 0xFF, (byte) 0xEE, (byte) 0xAD, (byte) 0xD5, (byte) 0x11, (byte) 0xFE
        },
        array);
  }
