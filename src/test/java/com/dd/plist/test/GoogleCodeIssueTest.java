...
public class GoogleCodeIssueTest {
  ...
  public void testIssue16() throws Exception {
    float x =
        ((NSNumber) PropertyListParser.parse(new File("test-files/issue16.plist"))).floatValue();
  ...
  public void testIssue21() throws Exception {
    String x =
        ((NSString) PropertyListParser.parse(new File("test-files/issue21.plist"))).toString();
  ...
  public void testIssue22() throws Exception {
    NSDictionary x1 =
        ((NSDictionary) PropertyListParser.parse(new File("test-files/issue22-emoji.plist")));
    NSDictionary x2 =
        ((NSDictionary) PropertyListParser.parse(new File("test-files/issue22-emoji-xml.plist")));
    BinaryPropertyListWriter.write(x1, new File("test-files/out-testIssue22.plist"));
    NSDictionary y1 =
        ((NSDictionary) PropertyListParser.parse(new File("test-files/out-testIssue22.plist")));
    XMLPropertyListWriter.write(x2, new File("test-files/out-testIssue22-xml.plist"));
    NSDictionary y2 =
        ((NSDictionary) PropertyListParser.parse(new File("test-files/out-testIssue22-xml.plist")));
    assertEquals(x1, x2);
    assertEquals(x1, y1);
    assertEquals(x1, y2);
    assertEquals(x2, y1);
  ...
  public void testIssue33() throws Exception {
    NSDictionary dict =
        (NSDictionary) PropertyListParser.parse(new File("test-files/issue33.pbxproj"));
  }
  ...
  public void testIssue38() throws Exception {
    NSDictionary dict =
        (NSDictionary) PropertyListParser.parse(new File("test-files/issue33.pbxproj"));
    NSObject fileRef =
        ((NSDictionary) ((NSDictionary) dict.get("objects")).get("65541A9C16D13B8C00A968D5"))
            .get("fileRef");
  ...
  public void testIssue41() {
    ...
    try {
      assertTrue(
          ((NSDictionary) PropertyListParser.parse(nullDict.toXMLPropertyList().getBytes()))
              .isEmpty());
    } catch (Exception e) {
      throw new AssertionError(
          "No exception should have occurred while parsing an empty dictionary", e);
    }
    ...
    try {
      ...
      throw new AssertionError(
          "Storing a NSArray containing a null value as a XML property list should throw an exception");
    ...
    try {
      ...
      throw new AssertionError(
          "Storing a NSArray containing a null value as a ASCII property list should throw an exception");
    } catch (NullPointerException ex) {
      // expected exception
    }
    ...
    try {
      ...
      throw new AssertionError(
          "Storing a NSArray containing a null value as a GnuStep ASCII property list should throw an exception");
    } catch (NullPointerException ex) {
      // expected exception
    }
    ...
    try {
      ...
      throw new AssertionError(
          "Storing a NSArray containing a null value as a binary property list should throw an exception");
    } catch (IOException ex) {
      // expect IOException because binary v1.0 format (which could theoretically store null values)
      // is not supported
      // But v1.0 format is not even supported by OS X 10.10, so there is no plan as of yet to
      // implement it
    }
  }
  ...
  public void testIssue49() throws Exception {
    NSDictionary dict =
        (NSDictionary) PropertyListParser.parse(new File("test-files/issue49.plist"));
