...
public class TestClassMap {
  ...
  public boolean equals(Object o) {
    ...
    if (stringMap != null ? !stringMap.equals(testClass.stringMap) : testClass.stringMap != null)
      return false;
    if (integerMap != null
        ? !integerMap.equals(testClass.integerMap)
        : testClass.integerMap != null) return false;
    if (longMap != null ? !longMap.equals(testClass.longMap) : testClass.longMap != null)
      return false;
    if (doubleMap != null ? !doubleMap.equals(testClass.doubleMap) : testClass.doubleMap != null)
      return false;
    if (floatMap != null ? !floatMap.equals(testClass.floatMap) : testClass.floatMap != null)
      return false;
    if (byteMap != null ? !byteMap.equals(testClass.byteMap) : testClass.byteMap != null)
      return false;
    if (shortMap != null ? !shortMap.equals(testClass.shortMap) : testClass.shortMap != null)
      return false;
    if (test1Map != null ? !test1Map.equals(testClass.test1Map) : testClass.test1Map != null)
      return false;
    if (test2Map != null ? !test2Map.equals(testClass.test2Map) : testClass.test2Map != null)
      return false;
