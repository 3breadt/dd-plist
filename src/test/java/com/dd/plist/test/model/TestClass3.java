...
public class TestClass3 {
  ...
  public String toString() {
    return "TestClass3{"
        + "\n StringArray="
        + Arrays.toString(aStringArray)
        + "\n IntegerArray="
        + Arrays.toString(aIntegerArray)
        + "\n LongArray="
        + Arrays.toString(aLongArray)
        + "\n DoubleArray="
        + Arrays.toString(aDoubleArray)
        + "\n FloatArray="
        + Arrays.toString(aFloatArray)
        + "\n ShortArray="
        + Arrays.toString(aShortArray)
        + "\n PrimitiveIntegerArray="
        + Arrays.toString(aPrimitiveIntegerArray)
        + "\n PrimitiveLongArray="
        + Arrays.toString(aPrimitiveLongArray)
        + "\n PrimitiveDoubleArray="
        + Arrays.toString(aPrimitiveDoubleArray)
        + "\n PrimitiveFloatArray="
        + Arrays.toString(aPrimitiveFloatArray)
        + "\n PrimitiveShortArray="
        + Arrays.toString(aPrimitiveShortArray)
        + "\n BooleanArray="
        + Arrays.toString(aBooleanArray)
        + "\n PrimitiveBooleanArray="
        + Arrays.toString(aPrimitiveBooleanArray)
        + "\n DateArray="
        + Arrays.toString(aDateArray)
        + "\n ByteArray="
        + Arrays.toString(aByteArray)
        + "\n PrimitiveByteArray="
        + Arrays.toString(aPrimitiveByteArray)
        + "\n}";
  }
