...
public class IssueTest {
  ...
  public void testIssue31_FalsePositiveForGZipInsideDataElement() throws Exception {
    ...
    NSData hash =
        (NSData)
            ((NSDictionary) files.get("Base.lproj/Main.storyboardc/MainController.nib"))
                .get("hash");
  ...
  public void testIssue51_BillionLaughsAttack() {
    ...
    try {
      ...
      // Expected exception for newer runtimes, then the parser will complain about the invalid
      // DOCTYPE
  ...
  public void testIssue72_OutOfMemory_BinaryPlist() {
    ...
    assertThrows(
        PropertyListFormatException.class, () -> BinaryPropertyListParser.parse(plistFile));
  }
